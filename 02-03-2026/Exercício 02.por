programa
{
   funcao inicio()
   {
      ...
      const cadeia APRESENTACAO = "Cálculo do Salário Anual"                             // Definição da constante APRESENTACAO, que será o título do programa. Este valor não pode ser modificado.
