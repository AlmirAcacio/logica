programa
{
   funcao inicio()
   {
      ...
      escreva("===========| " + APRESENTACAO + " |==========")           // Instrução de entrada da apresentação do programa, com a formatação padrão, concatenada com a constante APRESENTACAO.
      ...
      escreva("\n" + celsius + "°C equivalem a " + fahrenheit + "°F.")        // Instrução de retorno ou saída do resultado da expressão de conversão de Celsius para Fahrenheit.
