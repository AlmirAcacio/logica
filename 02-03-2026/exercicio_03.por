programa
{
   funcao inicio()
   {
      ...
      cadeia apresentacao = "Conversor de Temperatura (°C - °F)"              // Definição da variável apresentacao, que será o título do programa.
      ...
      escreva("\n", celsius, "°C equivalem a ", fahrenheit, "°F.\n")       // Instrução de retorno ou saída do resultado da expressão de conversão de Celsius para Fahrenheit armazenada na variável fahrenheit.
