programa
{
   funcao inicio()
   {
      inteiro ano_nascimento                   // Definição da variável ano_nascimento, que receberá um valor inteiro, a ser digitado pelo usuário.
      ...
      escreva("==========| " + apresentacao + " |==========")       /* Instrução de saída ou retorno da apresentação do programa pelo console, concatenada por formatações com 10 iguais e um traco na esquerda, 
      ...
      escreva("\nEm " + ANO_FUTURO + ", você terá " + resultado + " anos de idade.")       /* Instrução de retorno do resultado, concatenada com a variável ano_futuro e o resultado da expressão armazenada 
